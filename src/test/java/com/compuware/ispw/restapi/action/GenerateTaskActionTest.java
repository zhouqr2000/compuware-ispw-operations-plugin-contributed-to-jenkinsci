 ...
 * 
 */
public class GenerateTaskActionTest
{
	@Rule
	public TemporaryFolder tempFolder = new TemporaryFolder();
	
	private static Logger log = Logger.getLogger(GenerateTaskActionTest.class);
	PrintStream logger = System.out;
	
	@Before
	public void setUp() throws GitAPIException
	{
		System.out.println("GenerateTaskActionTest folder: " + tempFolder.getRoot().getAbsolutePath());
	}
	...
	/**
	 * Test method for {@link com.compuware.ispw.restapi.action.GenerateTaskAction#preprocess(String, String, FilePath, PrintStream, String, String)}.
	 * @throws IOException 
	...
	private class GenerateAction extends GenerateTaskAction
	{
