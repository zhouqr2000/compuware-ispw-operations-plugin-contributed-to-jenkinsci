...
public class BuildReleaseActionTest
{
	@Rule
	public TemporaryFolder tempFolder = new TemporaryFolder();
	
	private static Logger log = Logger.getLogger(BuildReleaseActionTest.class);
	PrintStream logger = System.out;
	
	@Before
	public void setUp() throws GitAPIException
	{
		System.out.println("BuildReleaseActionTest folder: " + tempFolder.getRoot().getAbsolutePath());
	}
	...
	private class BuildAction extends BuildReleaseAction
	{
		public BuildAction() {
			super(logger);
		}		
