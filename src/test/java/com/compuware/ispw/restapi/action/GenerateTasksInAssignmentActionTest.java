 ...
 * 
 */
public class GenerateTasksInAssignmentActionTest
{
	@Rule
	public TemporaryFolder tempFolder = new TemporaryFolder();
	
	private static Logger log = Logger.getLogger(GenerateTasksInAssignmentActionTest.class);
	PrintStream logger = System.out;
	
	@Before
	public void setUp() throws GitAPIException
	{
		System.out.println("GenerateAssignmentActionTest folder: " + tempFolder.getRoot().getAbsolutePath());
	}
	...
	/**
	 * Test method for {@link com.compuware.ispw.restapi.action.GenerateTasksInAssignmentAction#preprocess(String, String, FilePath, PrintStream, String, String)}.
	 * @throws IOException 
	...
	private class GenerateAction extends GenerateTasksInAssignmentAction
	{
