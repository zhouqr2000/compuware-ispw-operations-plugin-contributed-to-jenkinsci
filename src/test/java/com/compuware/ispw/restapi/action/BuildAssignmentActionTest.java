...
public class BuildAssignmentActionTest
{
	@Rule
	public TemporaryFolder tempFolder = new TemporaryFolder();
	
	private static Logger log = Logger.getLogger(BuildAssignmentActionTest.class);
	PrintStream logger = System.out;
	
	@Before
	public void setUp() throws GitAPIException
	{
		System.out.println("BuildAssignmentActionTest folder: " + tempFolder.getRoot().getAbsolutePath());
	}
	...
	private class BuildAction extends BuildAssignmentAction
	{
		public BuildAction() {
			super(logger);
		}		
