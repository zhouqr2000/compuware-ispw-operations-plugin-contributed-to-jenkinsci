...
public class DeployReleaseActionTest
{
	@Rule
	public TemporaryFolder tempFolder = new TemporaryFolder();
	
	private static Logger log = Logger.getLogger(DeployReleaseActionTest.class);
	PrintStream logger = System.out;
	
	@Before
	public void setUp() throws GitAPIException
	{
		System.out.println("DeployReleaseActionTest folder: " + tempFolder.getRoot().getAbsolutePath());
	}
	...
	private class DeployAction extends DeployReleaseAction
	{
		public DeployAction() {
			super(logger);
		}		
